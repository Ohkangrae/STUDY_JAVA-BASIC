...
/* 클래스와 객체
 클래스와 객체의 개념을 익히는 것이 세부 문법을 익히는 것만큼 중요하다.
...
1. 클래스의 개념
	...
	라고 볼수 있다. 따라서 한개의 클래스로 여러개의 객체를 만들 수 있다.
	...
	클래스 : 구조체는 데이터만 관리할 수 있다. 여기에 어떤 기능들(매서드)을
		...
		클래스의 밖에 올수 있는 것은 package import 또 다른 클래스 선언
		
		접근 지정자 public 은 한개의 .java파일안에서 최대 1개의 클래스에만 붙일 수 있다.
		
		객체라는 표현 인스턴스라는 표현은 같은 대상 가리킨다.
		클래스와의 관계를 표현할때는 인스턴스라고 하고
		단독으로 그 자체만 표현할때는 객체하고 한다.
