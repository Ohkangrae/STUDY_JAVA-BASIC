...
//가 나 다 라 마 다 사            가 나 다 라 마 다 사
	...
	public static void main(String[] args) {
		...
		// HashSet은 데이터의 중복을 허용하지 않는다. 즉 같은 데이터를 2개 이상 포함할수 없다.
		// 여기서 생각해 볼것은 '데이터가 같다' 또는 '데이터가 다르다'의 기준은 무엇일까...
		// 예를들면 3과 3은 같은 데이터이다. 즉 2개 이상을 저장 할수 없다. 
		// A a1 = new A(3) 과 A a2 = new A(3) 생성자에 동일한 값을 넘겨서 객체를
		// 생성 했으므로 두 객체는 완벽히 똑같다. 하지만 Set의 관점에서는 다른 객체이다. 
		// 즉 둘다 저장할수 있다. 똑 같은 예로 String s1 = new String("hi")
		// String s2 = new String("hi") 
		
		// 해시코드 의 개념 - 객체의 해시코드는 객체가 저장된 주소와 관련된 값으로 실제 번지 값은 아니다. 
		//               객페가 저장된 번지를 기준으로 생성된 정수형 고유값이 바로 해시코드 이다. 
